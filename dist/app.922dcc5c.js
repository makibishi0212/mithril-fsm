...
var _bloodtype = require("../consts/bloodtype");

var _bloodtype2 = _interopRequireDefault(_bloodtype);

var _sex = require("../consts/sex");
...
var registerFSM = function () {
  // 登録画面に現れるステートを定義
  function registerFSM() {
    var _this = this;

    _classCallCheck(this, registerFSM);

    this._stateMachine = new _javascriptStateMachine2.default({
      init: "INPUT_USERNAME",
      transitions: [{
        // +username
    ...
    this.movePasswordInput = function (username) {
      _this._stateMachine.movePasswordInput();

      _this._username = username;
    };

    this.movePersonalInfoInput = function (password) {
      _this._stateMachine.movePersonalInfoInput();

      _this._password = password;
    };

    this.moveSuccess = function (age, bloodtype, sex) {
      _this._stateMachine.moveSuccess();

      _this._bloodtype = bloodtype;
      _this._age = age;
      _this._sex = sex;
    };

    this.resetInput = function () {
      _this._stateMachine.resetInput();

      _this._username = null;
      _this._password = null;
      _this._bloodtype = null;
      _this._age = null;
      _this._sex = null;
    };

    this.state = function () {
      return _this._stateMachine.state;
    };
  }
...
var UsernameInput = function UsernameInput(registerFSM) {
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.view = function () {
        return [(0, _mithril2.default)('div.field', [(0, _mithril2.default)('label.label', 'username'), (0, _mithril2.default)('div.control', [(0, _mithril2.default)('input.input', {
            type: 'text',
        ...
        }), _this.username ? null : (0, _mithril2.default)('p', { class: (0, _classnames2.default)('help', 'is-danger') }, 'ユーザー名を入力して下さい！')])]), (0, _mithril2.default)('div.field.is-grouped', [(0, _mithril2.default)('div.control', [(0, _mithril2.default)('button.button.is-link', {
            disabled: _this.username ? false : true,
            onclick: function onclick() {
                _this.fsm.movePasswordInput(_this.username);
...
var PaswordInput = function PaswordInput(registerFSM) {
    _classCallCheck(this, PaswordInput);
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.view = function () {
        return [(0, _mithril2.default)('div.field', [(0, _mithril2.default)('label.label', 'password'), (0, _mithril2.default)('div.control', [(0, _mithril2.default)('input.input', {
            type: 'password',
            placeholder: 'Please enter password',
            value: _this.password1,
            oninput: _mithril2.default.withAttr('value', function (value) {
                _this.password1 = value;
            })
        })]), (0, _mithril2.default)('label.label', 're-enter password'), (0, _mithril2.default)('div.control', [(0, _mithril2.default)('input.input', {
            type: 'password',
            placeholder: 'Please enter password',
            value: _this.password2,
            oninput: _mithril2.default.withAttr('value', function (value) {
                _this.password2 = value;
            })
        })])]), (0, _mithril2.default)('div.field.is-grouped', [(0, _mithril2.default)('div.control', [(0, _mithril2.default)('button.button.is-link', {
            disabled: _this.password1 && _this.password2 && _this.password1 === _this.password2 ? false : true,
            onclick: function onclick() {
                _this.fsm.movePersonalInfoInput((0, _jsMd2.default)(_this.password1));
...
var PersonalInput = function PersonalInput(registerFSM) {
    _classCallCheck(this, PersonalInput);
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.resetProp = function () {
        _this.age = null;
        _this.sex = _sex2.default.MAN;
        _this.blood = _bloodtype2.default.A;
    };

    this.view = function () {
        return [(0, _mithril2.default)('div.field', [(0, _mithril2.default)('label.label', 'sex'), (0, _mithril2.default)('div.control', [(0, _mithril2.default)('span', { class: (0, _classnames2.default)('select') }, [(0, _mithril2.default)('select', {
            onchange: _mithril2.default.withAttr('selectedIndex', function (value) {
                switch (value) {
                    case 0:
                        _this.sex = _sex2.default.MAN;
                        break;
                    case 1:
                        _this.sex = _sex2.default.WOMAN;
                        break;
                }
            })
        }, [(0, _mithril2.default)('option', 'Man'), (0, _mithril2.default)('option', 'Woman')])])]), (0, _mithril2.default)('label.label', 'blood type'), (0, _mithril2.default)('div.control', [(0, _mithril2.default)('span', { class: (0, _classnames2.default)('select') }, [(0, _mithril2.default)('select', {
            onchange: _mithril2.default.withAttr('selectedIndex', function (value) {
                switch (value) {
                    case 0:
                        _this.blood = _bloodtype2.default.A;
                        break;
                    case 1:
                        _this.blood = _bloodtype2.default.B;
                        break;
                    case 2:
                        _this.blood = _bloodtype2.default.O;
                        break;
                    case 3:
                        _this.blood = _bloodtype2.default.AB;
                        break;
                }
            })
        }, [(0, _mithril2.default)('option', 'A'), (0, _mithril2.default)('option', 'B'), (0, _mithril2.default)('option', 'O'), (0, _mithril2.default)('option', 'AB')])])]), (0, _mithril2.default)('label.label', 'age'), (0, _mithril2.default)('div.control', [(0, _mithril2.default)('input.input', {
            type: 'text',
            placeholder: 'Please input user name',
            value: _this.age,
            oninput: _mithril2.default.withAttr('value', function (value) {
            ...
            disabled: _this.age && !isNaN(_this.age) ? false : true,
            onclick: function onclick() {
...
var _usernameInput = require("../components/register/usernameInput");

var _usernameInput2 = _interopRequireDefault(_usernameInput);

var _passwordInput = require("../components/register/passwordInput");

var _passwordInput2 = _interopRequireDefault(_passwordInput);

var _personalInput = require("../components/register/personalInput");
...
var Register = function Register(registerFSM) {
